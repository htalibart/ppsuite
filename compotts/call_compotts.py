...
def align_two_potts_models(mrfs, output_folder, n_limit_param=INFINITY, iter_limit_param=1000, t_limit=36000, disp_level=1, epsilon=1.0, v_score_function=scalar_product, w_score_function=scalar_product, w_threshold_method="none", use_w=True, use_v=True, gamma=1.0, theta=0.9, stepsize_min=0.000000005, nb_non_increasing_steps_max=500, vw_coeff_method = "arbitrary_1_1", gap_cost_method="arbitrary_5_0", **kwargs):
    ...
    v_scores, w_scores, edges_maps, selfcomps, gap_open, gap_extend = compute_scores_and_edges_maps_and_gap_costs(mrfs, v_score_function, w_score_function, use_v, use_w, vw_coeff_method, w_threshold_method, gap_cost_method, **kwargs)
