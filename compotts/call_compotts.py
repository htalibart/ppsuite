...
def align_two_potts_models(mrfs, output_folder, n_limit_param=10000000, iter_limit_param=1000, t_limit=36000, disp_level=1, epsilon=1, v_score_function=scalar_product, w_score_function=scalar_product, gap_open=0, gap_extend=0, w_threshold_method="none", use_w=True, **kwargs):
