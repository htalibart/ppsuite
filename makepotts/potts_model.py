...
class Potts_Model:
    ...
    @classmethod
    def from_training_set(cls, aln_file, binary_file, write_readme=True, readme_file=None, inference_method='CCMpredPy',  wt_cutoff=0.8, apply_zero_sum_gauge_if_mfdca=True, reg_lambda_w_mfdca=1, pc_tau_mfdca=0.5, shrinkage_coeff=0.5, mfdca_pc=False, **kwargs):
        """
        ...
        if inference_method=='CCMpredPy':
            ...
            v, w = rmfdca_main.infer_parameters_for_msa(aln_file, reg_lambda_w=reg_lambda_w_mfdca, pc_tau=pc_tau_mfdca, shrinkage_coeff=shrinkage_coeff, lattice=not(apply_zero_sum_gauge_if_mfdca), mfdca_pc=mfdca_pc) 
