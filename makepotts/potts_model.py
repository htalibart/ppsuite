...
class Potts_Model:
    ...
    @classmethod
    def from_training_set(cls, aln_file, binary_file, write_readme=True, readme_file=None, inference_method='CCMpredPy',  wt_cutoff=0.8, pc_tau_mfdca=0.5, shrinkage_coeff=0.9, mfdca_pc=False, apply_covariance_matrix_threshold_mfdca=True, **kwargs):
        """
