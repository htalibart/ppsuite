...
#    return 1-seq_identity(obj1.sequence, obj2.sequence)
#
#def inverse_seq_id_distance(obj1, obj2):
#    return 1-seq_id_distance(obj1, obj2)
#
#
...
#        return ComFeature.from_merge(obj1, obj2, aligned_positions, output_folder, **kwargs)
#
#
...
#        obj = ComFeature.from_files(sequence_file=seq_file, aln_file=a3m_file, output_folder=output_folder, feature_folder=pf, potts_model_file=mrf_file, **kwargs)
