...
#        insertion_penalties_new_learning_rate = infer_insertion_penalties_in_dict(a3m_file, pc_insertions_tau=0, learning_coeff_insertions=1)
#        print(insertion_penalties_new_learning_rate)
#        insertion_penalties_standard_learning_rate = infer_insertion_penalties_in_dict(a3m_file, pc_insertions_tau=0, learning_coeff_insertions=1e-3)
