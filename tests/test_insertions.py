...
#        aligned_positions, infos_solver = align_two_potts_models(mrfs, self.output_folder, insert_costs=insert_costs, sim_min=-100, epsilon_sim=-100, t_limit=100)
...
#       expected_aligned_positions = {"pos_ref":[0,1,2], "pos_2":[0,3,4]}
#       aligned_positions, infos_solver = align_two_potts_models(mrfs, self.output_folder, insert_costs=insert_costs, sim_min=-100, epsilon_sim=-100)
#       self.assertEqual(aligned_positions, expected_aligned_positions)
#       self.assertEqual(infos_solver['UB'], infos_solver['LB'])
#
#
...
#        expected_LB = scalar_product(mrfs[0].v[0],mrfs[1].v[0])
#        aligned_positions, infos_solver = align_two_potts_models(mrfs, self.output_folder, insert_costs=insert_costs, sim_min=-100, epsilon_sim=0.0001, n_limit_param=1)
#        self.assertEqual(aligned_positions, expected_aligned_positions)
...
#        expected_LB = scalar_product(mrfs[1].v[0],mrfs[1].v[0])
#        aligned_positions, infos_solver = align_two_potts_models(mrfs, self.output_folder, insert_costs=insert_costs, sim_min=-100, epsilon_sim=0.0001, n_limit_param=1)
#        self.assertEqual(aligned_positions, expected_aligned_positions)
...
#                        {"open":[0]*(mrf1.ncol+1), "extend":[0]*(mrf1.ncol+1)}
#                        ]
#        aligned_positions, infos_solver = align_two_potts_models([mrf2,mrf1], self.output_folder, insert_costs=insert_costs, sim_min=-100, epsilon_sim=0.0001)
#        self.assertEqual(infos_solver['UB'], infos_solver['LB'])
