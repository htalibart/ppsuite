...
class Test_Insertions(unittest.TestCase):
    ...
    def test_w_score_open_gap(self): # WILL NOT CONVERGE
        ...
        aligned_positions, infos_solver = align_two_potts_models([mrf1,mrf2], self.output_folder, insert_costs=insert_costs, sim_min=-100, epsilon_sim=0.0001, n_limit_param=1, iter_limit_param=1000000000, theta=2)
        self.assertEqual(infos_solver['UB'], infos_solver['LB'])
