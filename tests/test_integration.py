...
class Test_Integration(unittest.TestCase):
    ...
    def test_insertion(self):
        ...
        potts_main(["--potts_folder", str(self.potts_folder_2), "--aln_with_insertions", str(INSERTION_RESOURCES_FOLDER/'AiD.a3m'), "--use_insertion_penalties", "--dont_trim_alignment"])
        ...
        res_ppalign_1 = ppalign_main(["--potts_folder_1", str(self.potts_folder_1), "--potts_folder_2", str(self.potts_folder_2), "--output_folder", str(self.output_folder), "--get_sequences_fasta_aln", "--use_insertion_penalties"])
